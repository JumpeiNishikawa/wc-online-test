...
def select_noun():
    print("select_noun")
    with open("./D_Data.csv") as raw_data:
...
def export_chunk_file():
    data = make_word_chunk_form()

    with open("./word_mora.lisp", mode="a") as result_file:
