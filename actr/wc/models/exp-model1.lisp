(define-model-fct 'mp10-sim1
  (append 
    '(
      ...
      (add-dm-fct *chunk-list-tl2v*) ;*chunk-list-wo-tl*)
      (add-dm 
          (wc-answer ISA answer state start) )

      ;condition1
      (set-similarities-fct *mora-sim-list1*)
      ;(set-base-levels-fct *word-mora-base-levels*) ;*word-base-levels*)
