...
;;;;TRAIN;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defun run-n-train (sim-time num-of-sim trial-count log-file-name param-mp &optional (param-v nil) (real-time nil) (run-time 0.1))
  (let (
    (log-dir (concatenate 'string "./log/" log-file-name "/")) )
    (ensure-directories-exist log-dir)
...
(defun n-train (sim-time num-of-run num-of-trial log-file &optional (param-mp 10))
  (dotimes (trial-count num-of-trial)
    (run-n-train sim-time num-of-run trial-count log-file param-mp) ))